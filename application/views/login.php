...
<head>
  ...
  <title>SIM | Human Resource</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>SIM</b>Human Resource</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <?php echo form_open($form_action); ?>
      ...
      <div class="row">
        <div class="col-xs-8">
        <?php $flash_pesan = $this->session->flashdata('error_login')?>
      <?php if (! empty($flash_pesan)) : ?>
        <p class="text-justify"><?php echo $flash_pesan; ?></p>
